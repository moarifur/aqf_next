...
const Navbar = () => {
    ...
    return (
        <div
            className={`md:bg-transparent bg-gray-800 w-full fixed top-0 left-0 z-10 shadow-md transition-all duration-300 
            ${isScrolled ? 'bg-gray-700 md:bg-white text-black' : ''}`}
        >
